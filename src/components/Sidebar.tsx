function Sidebar() {
  return (
    <div className="space-y-4">
      <div className="space-y-6 bg-gray-100 w-full p-8 rounded-3xl">
        ...
        <div className="space-y-2">
          ...
          <div className="grid md:grid-cols-12 gap-3">
            <a
              href="#"
              className="block w-full text-center md:col-span-6 px-6 py-3 bg-gray-200 text-orange-600 font-semibold rounded-lg  hover:bg-orange-600 hover:text-white transition"
            >
              Call Us
            </a>
            <a
      ...
      <div className="grid md:grid-cols-12 bg-gray-100 w-full p-6 rounded-3xl">
